/**
 * pxlsmash Cloud API — Cloudflare Workers
 *
 * Endpoints:
...
async function authenticateRequest(
  ...
  if (data.usedThisMonth >= data.monthlyLimit) {
    return {
      ok: false,
      error: `Monthly limit reached (${data.monthlyLimit} images). Upgrade at https://pxlsmash.dev/pricing`,
    };
  }
