# Show HN: imgcrush — Metal GPU-accelerated image optimizer for macOS (20× faster)

I built imgcrush because I got tired of waiting for ImageMagick to process
...
imgcrush uses Apple Metal compute shaders for image processing — resize,
...
imgcrush ./images/ --quality 85 --format webp --recursive
```
...
Source + binary: https://github.com/htmeta/imgcrush
